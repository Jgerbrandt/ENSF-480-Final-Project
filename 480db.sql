...
INSERT INTO `discountcodes` VALUES (1,15.61);
...
CREATE TABLE `orders` (
  ...
  `RegisteredEmail` varchar(45) DEFAULT NULL,
  `OrdinaryEmail` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`OrderID`),
  KEY `Email_idx` (`RegisteredEmail`),
  CONSTRAINT `Email` FOREIGN KEY (`RegisteredEmail`) REFERENCES `registereduser` (`Email`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,NULL,'jason.wu1@ucalgary.ca');
...
INSERT INTO `registereduser` VALUES ('jason.wu4325@gmail.com','password','Jason','home','4000-5000-6000-9000','03-12-2022',1);
...
INSERT INTO `ticket` VALUES (1,1,1,1,1),(2,1,1,2,1);
...
-- Dump completed on 2022-12-03 13:31:39
